...
use vss::polynomials::{accumulator_poly, accumulator_poly_scheduled, accumulator_poly_slow, poly_eval};
...
fn test_accumulator_poly() {
    ...
    let Z_sched = accumulator_poly_scheduled(vec![r].as_slice(), &batch_dom, naive_thresh, fft_thresh);
